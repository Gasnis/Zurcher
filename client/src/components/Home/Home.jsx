...
export default function Home() {
  ...
  return (
    <div className={style.principalDiv}>
      ...
      <div>
        <button className={style.contactContainer} onClick={toContact}>Contact</button>
      </div>
        ...
        <div className={style.container}>
          <div className={style.card}>
            ...
            <div>
              ...
              <button className={style.btn} onClick={toContact}>
                BOOK
              </button>
            </div>
          </div>
      ...
      <div className={style.contactForm}>
        ...
        <div className={style.inputContainer}>
          ...
          <div>
            <input className={style.input} type="text" placeholder="Mail" />
          </div>

          <div>
            <input className={style.input} type="tel" placeholder="Phone" />
          </div>
      ...
      <div className={style.footer}>
        ...
        <div>
          <a href="mailto:zurcher.handyman@gmail.com">
